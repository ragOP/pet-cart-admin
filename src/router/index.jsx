...
const CategoryEditor = lazy(() =>
  import("@/pages/category/pages/category_editor")
);

const SubCategory = lazy(() => import("@/pages/sub_category"));
const SubCategoryEditor = lazy(() =>
  import("@/pages/sub_category/pages/sub_category_editor")
);
...
const CollectionEditor = lazy(() =>
  import("@/pages/collection/pages/collection_editor")
);

const Product = lazy(() => import("@/pages/product"));
const ProductEditor = lazy(() =>
  import("@/pages/product/pages/product_editor")
);
...
const BannerEditor = lazy(() =>
  import("@/pages/main_banner/pages/banner_editor")
);

const CatLifeBanners = lazy(() => import("@/pages/cat_life"));
const CatLifeBannerEditor = lazy(() =>
  import("@/pages/cat_life/pages/slider_editor")
);

const ProductBanner = lazy(() => import("@/pages/product_banner"));
const ProductBannerEditor = lazy(() =>
  import("@/pages/product_banner/pages/product_banner_editor")
);
...
const BlogFeaturedProducts = lazy(() =>
  import("@/pages/blog_featured_products")
);
    ...
    <Routes>
      ...
      <Route element={<ProtectedRoute />}>
        <Route path="/dashboard" element={<Layout />}>
          ...
          />
          <Route
            path="page-configuration/:pageKey"
            element={
              <Suspense
                fallback={
                  <div className="w-full h-screen flex items-center justify-center">
          ...
          />
          <Route
            path="banners/edit/:selectedType"
            element={
              <Suspense
                fallback={
                  <div className="w-full h-screen flex items-center justify-center">
