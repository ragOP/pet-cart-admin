...
import { exportSubCategories } from "../helpers/exportSubCategories";
...
const ExportCategoryDialog = ({
  ...
  const { mutate: exportMutation, isPending } = useMutation({
    mutationFn: async (type) => {
      ...
      const apiResponse = await exportSubCategories({ params: updatedParams });
      if (apiResponse?.response?.success) {
        ...
        link.setAttribute(
          "download",
          data.filename || (type === "csv" ? "category.csv" : "category.xlsx")
        );
